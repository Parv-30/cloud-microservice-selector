package com.arithmetic.subtract.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> badRequest(Exception ex) {
        return build(HttpStatus.BAD_REQUEST, ex.getMessage(), "INVALID_INPUT", "subtract", null);
    }

    @ExceptionHandler(Exception.class)
    public ResponseEntity<Map<String, Object>> internal(Exception ex) {
        return build(HttpStatus.INTERNAL_SERVER_ERROR, "internal server error", "INTERNAL_ERROR", "subtract", null);
    }
